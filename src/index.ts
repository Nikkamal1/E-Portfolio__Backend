...
app.post("/api/profile", async (req: Request, res: Response) => {
  const { name, walletAddress, bio, education, workExperience, skills, portfolio, awards } = req.body;
  ...
  try {
    ...
    if (existingProfile) {
      ...
      const updatedProfile = await Profile.findOneAndUpdate(
        { walletAddress },
        { $set: { name, bio, education, workExperience, skills, portfolio, awards } },
      ...
      // สร้างโปรไฟล์ใหม่
      const newProfile = new Profile({ name, walletAddress, bio, education, workExperience, skills, portfolio, awards });
